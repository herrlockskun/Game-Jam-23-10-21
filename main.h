...
for (int j=0;j<20;++j)
{
	...
	erreur1 = initListeTuyau(&l_tuyau);
	erreur2 = initTuyau(&l_tuyau);
	l_tuyau->liste[l_tuyau->taille-1]->lien_contenu_case[0][0]=10;
	l_tuyau->liste[l_tuyau->taille-1]->lien_contenu_case[0][1]=10;
